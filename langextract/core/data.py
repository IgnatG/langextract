...
class Extraction:
    ...
    Attributes:
      ...
      confidence_score: Cross-pass confidence score in ``[0.0, 1.0]``,
        representing the fraction of extraction passes that produced this
        extraction.  ``None`` when only a single pass was run.
