    ...
    *,
    ...
    Args:
        ...
        require_grounding: Whether to filter out extractions that cannot be
          ...
          end_pos) are returned. This helps prevent returning extractions that
          may have been extracted from few-shot examples rather than the actual
          input text. Defaults to False for backward compatibility.
